...
----------------------------------------*/
class zeus_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('zeus_instagram_photo',esc_html__('[ Zeus ] Intagram Photo','zeus-companion'),array(
			'description' => esc_html__('Zeus Instagram Photo Widget','zeus-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'zeus-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'zeus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'zeus-companion'); ?></label>
...
if(!function_exists('zeus_instagram_widgets')):
	function zeus_instagram_widgets(){
		register_widget('zeus_instagram_photo');
	}
	add_action('widgets_init','zeus_instagram_widgets');
endif;
